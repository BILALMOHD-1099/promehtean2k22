...
function Cheifs() {
  return (
     <div
      ...
      style={{ display: "flex", justifyContent: "center", marginTop: 50, backgroundColor: "#f6f7fd",padding:"60px"}}
    >
      <div style={{ width: "90%", textAlign: "center" }}>
        <h1 style={{ marginBottom: 20 ,fontSize: 36,
    textTransform: "uppercase",
    textAlign: "center",
    fontWeight: 700,
    marginBottom: 10}}>TESTIMONIALS</h1>
